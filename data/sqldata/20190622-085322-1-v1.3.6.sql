...
-- Host           : 127.0.0.1:3306
-- Database       : eyoucms1223ada
-- 
-- Part : #1
-- Version : #v1.3.6
-- Date : 2019-06-22 08:53:22
-- -----------------------------------------
...
-- Records of `ey_admin`
-- -----------------------------
INSERT INTO `ey_admin` VALUES ('1', 'admin', '', 'admin', '', '', '9f9cd402ad6602d3803885d5c06d8475', '1561164795', '127.0.0.1', '3', 'qe4tr24fcb6s65qmtrk3qm9fr6', '0', '-1', 'cn', '1', '1561164760', '0');
...
-- -----------------------------
INSERT INTO `ey_arcmulti` VALUES ('1', 'arclist0a3625740af842dc94d8805fe9fbc51d', 'arclist', '', '10', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (35,39,40,41,42,35) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 10', 'a.sort_order asc, a.aid desc', '', '', 'a:3:{s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:3:\\\"160\\\";s:6:\\\"typeid\\\";s:17:\\\"35,39,40,41,42,35\\\";}', '1558922752', '1558922752');
INSERT INTO `ey_arcmulti` VALUES ('2', 'arclistd188c7fa87877a504098de1e4297995f', 'arclist', '', '4', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (36,36) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 4', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:5:\\\"limit\\\";s:3:\\\"0,4\\\";s:7:\\\"infolen\\\";s:3:\\\"160\\\";s:6:\\\"typeid\\\";s:5:\\\"36,36\\\";}', '1558922752', '1558922752');
INSERT INTO `ey_arcmulti` VALUES ('3', 'arclist500f48e1e00a853656b8f6626e58e2db', 'arclist', '', '7', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (36,36) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 7', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:5:\\\"limit\\\";s:3:\\\"4,7\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";s:6:\\\"typeid\\\";s:5:\\\"36,36\\\";}', '1558922752', '1558922752');
INSERT INTO `ey_arcmulti` VALUES ('4', 'arclist91d085256352751c13e57eb83d601d28', 'arclist', '', '10', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (37,37) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 10', 'a.sort_order asc, a.aid desc', '', '', 'a:3:{s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";s:6:\\\"typeid\\\";s:5:\\\"37,37\\\";}', '1558922752', '1558922752');
INSERT INTO `ey_arcmulti` VALUES ('5', 'arclist3908c8969b1d71142efb15135c871f05', 'arclist', '', '10', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (2,2) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 10', 'a.sort_order asc, a.aid desc', '', '', 'a:3:{s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";s:6:\\\"typeid\\\";s:3:\\\"2,2\\\";}', '1558922752', '1558922752');
...
-- -----------------------------
INSERT INTO `ey_channeltype` VALUES ('1', 'article', '文章模型', '文章', 'article', 'Article', '1', '1', '1', '0', '1', '0', '1561164795');
INSERT INTO `ey_channeltype` VALUES ('4', 'download', '下载模型', '下载', 'download', 'Download', '0', '1', '1', '0', '4', '0', '1561164795');
INSERT INTO `ey_channeltype` VALUES ('2', 'product', '产品模型', '产品', 'product', 'Product', '0', '1', '1', '0', '2', '0', '1561164795');
INSERT INTO `ey_channeltype` VALUES ('8', 'guestbook', '留言模型', '留言', 'guestbook', 'Guestbook', '1', '1', '1', '0', '8', '1509197711', '1561164795');
INSERT INTO `ey_channeltype` VALUES ('6', 'single', '单页模型', '单页', 'single', 'Single', '1', '1', '1', '0', '6', '1523091961', '1561164795');
INSERT INTO `ey_channeltype` VALUES ('3', 'images', '图集模型', '图集', 'images', 'Images', '0', '1', '1', '0', '3', '1523929121', '1561164795');
...
INSERT INTO `ey_config` VALUES ('463', '_cmscopyright', 'cTT9djEDEdcizypkaevjEBt1', 'php', '', 'cn', '0', '1558922752');
INSERT INTO `ey_config` VALUES ('466', 'web_is_authortoken', '-1', 'web', '', 'cn', '0', '1561164797');
...
INSERT INTO `ey_config` VALUES ('477', 'system_auth_code', 'AOjV6eTadphwolIlvPLj', 'system', '', 'cn', '0', '1561164760');
